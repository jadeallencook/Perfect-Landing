...
/* footer links */
$('#andylab').click(function () {
    window.open('http://shapebootstrap.net/item/1525511-prohome-responsive-real-estate/live-demo');
});
...
$('#perfectlanding').click(function () {
    window.open('http://www.perfectlandingrentals.com');
});
...
$(window).scroll(function () {
    ...
    // Fixed
    $(this).scrollTop() > 170 ? $headerFixed.css({
...
$('.fixed-height', document.body).css({
        'height': $pageHeight + 'px'
    }) // SETTING HEIGHT
$('.fixed-height-map', document.body).css({
        'height': ($pageHeight - 78) + 'px'
    }) // SETTING HEIGHT
...
function hideSearcher(navigatorMap) {
    if (navigatorMap == true) {
        ...
        if (searchText == true) {
            $('#search-box > div > div > span').empty().append('<i class="fa fa-chevron-up"></i> SHOW SEARCH OPTIONS');
            searchText = false;
        } else {
            $('#search-box > div > div > span').empty().append('<i class="fa fa-chevron-down"></i> HIDE SEARCH OPTIONS');
            searchText = true;
        }
    }
    return false;
...
$(function () {
    ...
    $('.next, .previous', feedbackContainer).on('click', function () {
        ...
        $messageBox.removeAttr('style').css({
            'height': parseInt($('.message').css('height'), 10) + 'px'
        });
    ...
    $('.message .more-button', feedbackContainer).on('click', function () {
        ...
        if (parseInt($feedbackBlock.css('height'), 10) != $feedbackContent.attr('data-min')) {
            $feedbackBlock.css({
                'height': $feedbackContent.attr('data-min') + 'px'
            });
        } else {
            $feedbackBlock.css({
                'height': $feedbackContent.attr('data-max') + 'px'
            });
        }
...
$(document).ready(function () {
    ...
    $(window).scroll(function () {
        $(this).scrollTop() > 300 ? $buttonScroll.addClass('active') : $buttonScroll.removeClass('active');
    });
