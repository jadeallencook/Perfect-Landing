      ...
      <div className="search-options sample-page">
        <div className="searcher">
          <div className="row margin-div" id="searcher-container">
            <div
              className="col-sm-12 col-md-12 margin-bottom"
              id="prop-name-search"
            >
                ...
                placeholder={
                  props.properties[
                    Object.keys(props.properties)[
                      (Object.keys(props.properties).length * Math.random()) <<
                        0
                    ]
                  ].propname['_text']
                }
                onChange={event => props.search('name', event.target.value)}
            ...
            <div className="col-sm-6 col-md-3 margin-bottom">
              ...
              <input
                ...
                onChange={event => props.search('checkin', event.target.value)}
                value={props.filters.checkin}
              />
            </div>
            <div className="col-sm-6 col-md-3 margin-bottom">
              ...
              <input
                ...
                onChange={event => props.search('checkout', event.target.value)}
                value={props.filters.checkout}
              />
            </div>
            <div className="col-sm-6 col-md-3 margin-bottom">
              <label>Sleeps</label>
              ...
              >
                <option value={0} default>-- All Sleeps --</option>
                {[
                  { text: '1-4', value: 1 },
                  { text: '5-8', value: 5 },
                  { text: '9-12', value: 9 },
                  ...
                  return (
                    <option key={object.text} value={object.value}>
                      {object.text} Guests
                    </option>
                  );
                })}
          ...
          <div
            className="row filter hide-filter hidden-xs hidden-sm"
            id="filters"
          ></div>
