      ...
      <div className="row">
        ...
        <div className="col-md-12 space-div">
          ...
          <select
            className="form-control"
            id="bedroom"
            defaultValue={props.filters.beds}
          >
        ...
        <div className="col-md-12 space-div">
          ...
          <input
            ...
            defaultValue={props.filters.checkin}
          />
        </div>
        <div className="col-md-12 space-div">
          ...
          <input
            ...
            defaultValue={props.filters.checkout}
          />
          <button
            type="button"
            ...
            onClick={event => {
              ...
              let amenities =
                props.filters.amenities.length > 0
                  ? props.filters.amenities
                  : [];
              amenities =
                amenities.indexOf(filter) === -1
                  ? [...amenities, filter]
                  : amenities.filter(amenity =>
                      amenity !== filter ? true : false
                    );
              props.search('amenities', amenities);
            }}
            style={
              props.filters.amenities.indexOf(filter) === -1
                ? { opacity: '0.75' }
                : { opacity: '1' }
            }
          >
